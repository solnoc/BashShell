...
{  
  ...
  if(Value & ELF::EF_RL78_FU_EXIST){
    ...
    SetFlags.push_back({"EF_RL78_FU_NONE", EF_RL78_FU_NONE});
  }

  if(Value & ELF::EF_RL78_EI_EXIST){
    SetFlags.push_back({"EF_RL78_EI_EXIST",EF_RL78_EI_EXIST});S
  }
  else{
    SetFlags.push_back({"EF_RL78_EI_NONE", EF_RL78_EI_NONE});
  }
  ...
  if((Value & ELF::EF_RL78_MAA_1) == ELF::EF_RL78_MAA_1){
    ...
    SetFlags.push_back({"EF_RL78_MAA_COMMON", EF_RL78_MAA_COMMON});
  }
  ...
  if((Value & ELF::EF_RL78_CPU_16BIT) == ELF::EF_RL78_CPU_16BIT){
    ...
    SetFlags.push_back({"EF_RL78_CPU_COMMON", EF_RL78_CPU_COMMON});
  }
  ...
  if((Value & ELF::EF_RL78_DOUBLE_8) == ELF::EF_RL78_DOUBLE_8){
    ...
    SetFlags.push_back({"EF_RL78_DOUBLE_COMMON", EF_RL78_DOUBLE_COMMON});
  }
  ...
  if((Value & ELF::EF_RL78_TEXT_FAR) == ELF::EF_RL78_TEXT_FAR){
    ...
    SetFlags.push_back({"EF_RL78_TEXT_COMMON", EF_RL78_TEXT_COMMON});
  }
  ...
  if((Value & ELF::EF_RL78_DATA_FAR) == ELF::EF_RL78_DATA_FAR){
    ...
    SetFlags.push_back({"EF_RL78_DATA_COMMON", EF_RL78_DATA_COMMON});
  }
  ...
  if((Value & ELF::EF_RL78_RODATA_FAR) == ELF::EF_RL78_RODATA_FAR){
    ...
    SetFlags.push_back({"EF_RL78_RODATA_COMMON", EF_RL78_RODATA_COMMON});
  }
